    ...
    periods: [
      {
        ...
        sessions: [
          ...
          "Mĩ Thuật - GV: Sầm Thị Thảo",
          "Hoạt động trải nghiệm, hướng nghiệp - GV: Phạm Hồng Loan",
          "Anh văn giao tiếp 6 - GV AVGT6_2",
          "Văn - GV: Nguyễn Thị Út Quyên",
          "Toán - GV: Phạm Hồng Loan",
        ],
      },
      {
        time: "Tiết 2",
        sessions: [
          "Giáo dục công dân - GV: Lê Thuỷ Quỳnh",
          "Ngoại ngữ - GV: Phan Nguyễn Thuỷ Linh",
          "Giáo dục địa phương - GV: Trần Đăng Khoa",
          "Văn - GV: Nguyễn Thị Út Quyên",
          "Công nghệ - GV: Trịnh Tuyết Mai",
          "Lịch sử và Địa lý - GV: Bùi Gia Phú",
        ],
      },
      {
        time: "Tiết 3",
      ...
      },
      {
        ...
        sessions: [
          ...
          "Văn - GV: Nguyễn Thị Út Quyên",
          "Toán - GV: Phạm Hồng Loan",
          "STEM (Thực hành) - GV: Nguyễn Thị Thảo",
          "Lịch sử và Địa lý - GV: Bùi Gia Phú",
          "Khoa học tự nhiên - GV: KHTN 1",
        ],
      },
      {
        ...
        sessions: [
          ...
          "Toán - GV: Phạm Hồng Loan",
          "Lịch sử và Địa lý - GV: Bùi Gia Phú",
          "Kỹ năng sống - GV: Nguyễn Hồ Gia Hân",
        ],
      },
    ],
  },
...
const subjectColors = {
  ...
  "Ngoại ngữ": "bg-purple-100 text-purple-800 border-purple-200",
  "Khoa học tự nhiên": "bg-orange-100 text-orange-800 border-orange-200",
  "Giáo dục thể chất (Thể dục)": "bg-red-100 text-red-800 border-red-200",
  "Âm Nhạc": "bg-pink-100 text-pink-800 border-pink-200",
  "Giáo dục công dân": "bg-yellow-100 text-yellow-800 border-yellow-200",
  "Hoạt động trải nghiệm, hướng nghiệp": "bg-teal-100 text-teal-800 border-teal-200",
  "Anh văn giao tiếp 6": "bg-indigo-100 text-indigo-800 border-indigo-200",
  "Công nghệ": "bg-cyan-100 text-cyan-800 border-cyan-200",
  "Lịch sử và Địa lý": "bg-emerald-100 text-emerald-800 border-emerald-200",
  "Giáo dục địa phương": "bg-lime-100 text-lime-800 border-lime-200",
  "Mĩ Thuật": "bg-violet-100 text-violet-800 border-violet-200",
  "STEM (Thực hành)": "bg-rose-100 text-rose-800 border-rose-200",
  "Tin học": "bg-slate-100 text-slate-800 border-slate-200",
  "Kỹ năng sống": "bg-amber-100 text-amber-800 border-amber-200",
}
